...
export const teacherPayout = {
  ...
  detailPage: {
    ...
    titleMmClose: ')',
    sectionSummaryMmBetweenMonthAndTeacher: ' အတွက် ',
    sectionSummaryMmSuffix: ' ၏ အကျဉ်းချုပ်',
    ...
    amountsEquationAria: 'အခြေခံ နှင့် အပိုဆုငွေ ပေါင်းလဒ် စုစုပေါင်းပေးချေရမည့်ငွေ',
