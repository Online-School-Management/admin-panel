/**
 * Student Payment feature translations (Myanmar)
 */

export const studentPayment = {
  // Page titles
  pages: {
    list: 'ကျောင်းသားငွေပေးချေမှုများ',
    detail: 'ငွေပေးချေမှု အသေးစိတ်',
    edit: 'ငွေပေးချေမှု တည်းဖြတ်ရန်',
  },

  // Descriptions
  descriptions: {
    list: 'ကျောင်းသားငွေပေးချေမှုအားလုံးနှင့် ၎င်းတို့၏ အခြေအနေကို စီမံခန့်ခွဲပါ',
    detail: 'ဤငွေပေးချေမှု၏ အသေးစိတ်အချက်အလက်များကို ကြည့်ရှုပါ',
    edit: 'ငွေပေးချေမှု အချက်အလက်ကို အပ်ဒိတ်လုပ်ပါ',
  },

  // Form labels
  form: {
    title: 'ငွေပေးချေမှု အပ်ဒိတ်လုပ်ရန်',
    status: 'အခြေအနေ',
    amountPaid: 'ပေးချေထားသော ငွေပမာဏ',
  ...
  dialog: {
    ...
    paymentDateForFeeMonth: 'ပေးချေသည့်ရက် (ကြေးသွင်းရမည့်လ {{month}})',
    paymentDateBulk: 'ပေးချေသည့်ရက် (ရွေးထားသော လအားလုံးအတွက်)',
    paymentDateFallback: 'ပေးချေသည့်ရက်',
    paymentDateHint: 'ယနေ့အတိုင်း ထားပါ သို့မဟုတ် အမှန်တကယ် ပေးချေသည့်ရက်ကို ရွေးပါ။',
    prePayment: 'ကြိုတင်ငွေပေးချေမှု',
    prePaymentTitle: 'ကြိုတင်ငွေပေးချေမှု - လများ ရွေးချယ်ပါ',
    prePaymentDescription: 'ပေးချေပြီးဟု အမှတ်အသားပြုရန် လများကို ရွေးချယ်ပါ။',
    selectedMonths: 'ရွေးချယ်ထားသည်: {{count}} လ',
    totalAmount: 'စုစုပေါင်း ငွေပမာဏ',
    noMorePendingMonths: 'ဤစာရင်းသွင်းမှုအတွက် ကျန်ရှိသော ပေးဆောင်ရန် လများ မရှိတော့ပါ။',
    confirmBulk: 'အတည်ပြု ({{count}} လ)',
    backToSingle: 'နောက်သို့',
  },
