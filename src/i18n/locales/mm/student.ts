...
export const student = {
  ...
  form: {
    ...
    education: 'ပညာရေး',
    enterEducation: 'ဥပမာ ဒသမတန်း၊ အထက်တန်းကျောင်း',
    schoolType: 'ကျောင်း',
    selectSchoolType: 'ကျောင်းအမျိုးအစား ရွေးပါ',
    schoolGovernment: 'အစိုးရ',
    schoolInternational: 'နိုင်ငံတကာ',
    schoolPrivate: 'ပုဂ္ဂလိက',
    schoolOther: 'အခြား',
    schoolOtherSpecify: 'ကျောင်းအမည် (အခြား)',
